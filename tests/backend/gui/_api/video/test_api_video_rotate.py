# tests\backend\gui\_api\video\test_api_video_rotate.py
...
from file_conversor.backend.gui._api.video.rotate import api_video_rotate, EXTERNAL_DEPENDENCIES
...
class TestAPIVideoRotate:
    def test_rotate(self, tmp_path: Path):
        url = FlaskRoute.get_url(api_video_rotate)
        ...
        assert (tmp_path / "test_rotated.mp4").exists()
