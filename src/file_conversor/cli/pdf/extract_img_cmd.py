...
class PdfExtractImgTyperCommand(AbstractTyperCommand):
...
""")
    ...
    def extract_img(
        ...
        cmd_mgr = CommandManagerRich(input_files, output_dir=output_dir, overwrite=True)  # allow overwrite to avoid detecting PDF file as existing
