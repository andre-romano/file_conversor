...
from file_conversor.backend.audio_video.ffmpeg_filter import FFmpegFilter, FFmpegFilterDeshake, FFmpegFilterEq, FFmpegFilterMInterpolate, FFmpegFilterScale, FFmpegFilterUnsharp
...
from file_conversor.utils.typer_utils import BrightnessOption, ColorOption, ContrastOption, DeshakeOption, FPSOption, GammaOption, InputFilesArgument, OutputDirOption, ResolutionOption, UnsharpOption, VideoBitrateOption
...
@typer_cmd.command(
    ...
    help=f"""
        {_('Enhance video bitrate, fps, color, brightness, contrast, sharpness, gamma.')}
    """,
    epilog=f"""
        **{_('Examples')}:**
...
def enhance(
    ...
    def callback(input_file: Path, output_file: Path, progress_mgr: ProgressManager):
        ...
        ffmpeg_backend.set_video_codec(bitrate=video_bitrate, filters=video_filters_obj)
