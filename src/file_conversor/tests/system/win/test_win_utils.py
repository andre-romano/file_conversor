...
class TestWinUtils:
    ...
    def test_restart_explorer(self,):
        ...
        subprocess.run = lambda *args, **kwargs: None  # pyright: ignore[reportUnknownLambdaType]  # noqa: ARG005
        subprocess.Popen = lambda *args, **kwargs: None  # pyright: ignore[reportUnknownLambdaType] # noqa: ARG005
    ...
    def test_get_window_hwnd(self,):
        ...
        ctypes.windll.user32.FindWindowW = lambda *args, **kwargs: 12345  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005

        try:
            hwnd = WindowsSystem._get_window_hwnd("NonExistentWindowTitle")  # pyright: ignore[reportPrivateUsage]  # noqa: SLF001
            assert hwnd == 12345  # noqa: PLR2004
    ...
    def test_set_window_icon(self,):
        ...
        ctypes.windll.user32.FindWindowW = lambda *args, **kwargs: 12345  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005
        ctypes.windll.user32.LoadImageW = lambda *args, **kwargs: 67890  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005
        ctypes.windll.user32.SendMessageW = lambda *args, **kwargs: 0  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005
    ...
    def test_set_window_icon_invalid(self,):
        ...
        original_sendmessagew = ctypes.windll.user32.SendMessageW
        ctypes.windll.user32.FindWindowW = lambda *args, **kwargs: 12345  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005
        ctypes.windll.user32.LoadImageW = lambda *args, **kwargs: 0  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005
        ctypes.windll.user32.SendMessageW = lambda *args, **kwargs: 0  # pyright: ignore[reportUnknownLambdaType, reportAttributeAccessIssue]  # noqa: ARG005
        try:
