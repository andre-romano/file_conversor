...
from file_conversor.cli.video.list_formats_cli import VideoListFormatsCommand
from file_conversor.tests.utils import DATA_PATH, TestTyper


@pytest.mark.skipif(not VideoListFormatsCommand.check_dependencies(), reason="External dependencies not installed")
