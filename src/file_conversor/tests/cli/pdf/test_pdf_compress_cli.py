...
from file_conversor.cli.pdf.compress_cli import PdfCompressCommand
from file_conversor.tests.utils import DATA_PATH, TestTyper


@pytest.mark.skipif(not PdfCompressCommand.check_dependencies(), reason="External dependencies not installed")
