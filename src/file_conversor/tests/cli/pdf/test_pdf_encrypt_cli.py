...
from file_conversor.cli.pdf.encrypt_cli import PdfEncryptCommand
from file_conversor.tests.utils import DATA_PATH, TestTyper


@pytest.mark.skipif(not PdfEncryptCommand.check_dependencies(), reason="External dependencies not installed")
