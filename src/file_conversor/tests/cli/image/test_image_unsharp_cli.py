...
from file_conversor.cli.image.unsharp_cli import ImageUnsharpCommand
from file_conversor.tests.utils import DATA_PATH, TestTyper


@pytest.mark.skipif(not ImageUnsharpCommand.check_dependencies(), reason="External dependencies not installed")
