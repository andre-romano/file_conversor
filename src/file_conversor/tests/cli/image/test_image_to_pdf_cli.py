...
from file_conversor.cli.image.to_pdf_cli import ImageToPdfCommand
from file_conversor.tests.utils import DATA_PATH, TestTyper


@pytest.mark.skipif(not ImageToPdfCommand.check_dependencies(), reason="External dependencies not installed")
