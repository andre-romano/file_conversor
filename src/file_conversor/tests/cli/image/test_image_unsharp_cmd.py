...
class TestImageUnsharp:
    def test_image_unsharp_cases(self, tmp_path):
        ...
        for in_path, out_path in test_cases:
            result = TestTyper.invoke(
                AppCommands.IMAGE.value, ImageTyperGroup.Commands.UNSHARP.value,
                str(in_path),
                "-r", "3",
    ...
    def test_image_unsharp_help(self,):
        TestTyper.invoke_test_help(AppCommands.IMAGE.value, ImageTyperGroup.Commands.UNSHARP.value)
