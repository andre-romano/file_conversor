...
from file_conversor.cli.image.info_cli import ImageInfoCommand
from file_conversor.tests.utils import DATA_PATH, TestTyper


@pytest.mark.skipif(not ImageInfoCommand.check_dependencies(), reason="External dependencies not installed")
