...
from file_conversor.cli.pipeline.create_cli import PipelineCreateCommand
from file_conversor.tests.utils import TestTyper


@pytest.mark.skipif(not PipelineCreateCommand.check_dependencies(), reason="External dependencies not installed")
