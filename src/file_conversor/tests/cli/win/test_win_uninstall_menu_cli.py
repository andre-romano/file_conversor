...
from file_conversor.cli.win.uninstall_menu_cli import WinUninstallMenuCommand
...
@pytest.mark.skipif(not WinUninstallMenuCommand.check_dependencies(), reason="External dependencies not installed")
