...
from file_conversor.cli.win import WinInstallMenuCLI
...
@pytest.mark.skipif(not TestTyper.dependencies_installed(WinInstallMenuCLI.EXTERNAL_DEPENDENCIES), reason="External dependencies not installed")
class TestWindowsInstallMenuCLI:
