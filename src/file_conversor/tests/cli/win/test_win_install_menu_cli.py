...
from file_conversor.cli.win.install_menu_cli import WinInstallMenuCommand
...
@pytest.mark.skipif(not WinInstallMenuCommand.check_dependencies(), reason="External dependencies not installed")
