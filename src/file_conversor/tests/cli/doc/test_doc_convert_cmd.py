...
@pytest.mark.skipif(not TestTyper.dependencies_installed(DocConvertCommand.EXTERNAL_DEPENDENCIES), reason="External dependencies not installed")
class TestDocConvert:
    def test_doc_convert_cases(self, tmp_path):
