...
from file_conversor.backend.gui.image._dom_page import image_index_nav_item, image_resize_nav_item

from file_conversor.utils.bulma_utils import InputFilesField, OutputDirField, ImageResampleAlgorithmField, ImageScaleField
...
def PageImageResize():
    return PageForm(
        ...
        nav_items=[
            ...
            image_resize_nav_item(active=True),
        ],
